...
handle_t hSolutionBinding;


static const RPC_CLIENT_INTERFACE Solution___RpcClientInterface =
    {
...
RPC_IF_HANDLE Solution_v1_0_c_ifspec = (RPC_IF_HANDLE)& Solution___RpcClientInterface;

extern const MIDL_STUB_DESC Solution_StubDesc;

static RPC_BINDING_HANDLE Solution__MIDL_AutoBindHandle;
    ...
    /* [size_is][in] */ unsigned char *password)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Solution_StubDesc,
                  (PFORMAT_STRING) &Solution__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&login);
    ...
    /* [string][in] */ const unsigned char *filename)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Solution_StubDesc,
                  (PFORMAT_STRING) &Solution__MIDL_ProcFormatString.Format[42],
    ...
    /* [in] */ unsigned long bfSize)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Solution_StubDesc,
                  (PFORMAT_STRING) &Solution__MIDL_ProcFormatString.Format[72],
                  ( unsigned char * )&iFilename);
    ...
    /* [in] */ unsigned long start)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Solution_StubDesc,
                  (PFORMAT_STRING) &Solution__MIDL_ProcFormatString.Format[120],
                  ( unsigned char * )&iFilename);
    return ( int  )_RetVal.Simple;
...
void LogoutUserRequest( void)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Solution_StubDesc,
                  (PFORMAT_STRING) &Solution__MIDL_ProcFormatString.Format[174],
                  ( unsigned char * )0);
...
static const MIDL_STUB_DESC Solution_StubDesc = 
    {
    (void *)& Solution___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hSolutionBinding,
    0,
